...
class Parser:
    def __init__(self, path):
        ...
        self.doc_id, self.entity_mentions, self.event_mentions = self.parse_xml(path + '.apf.xml')
    ...
    def parse_xml(self, xml_path):
        ...
        root = tree.getroot()
        doc_id = tree.find('document').items()[0][1]
        for child in root[0]:
            if child.tag == 'entity':
        ...
        return doc_id, entity_mentions, event_mentions
